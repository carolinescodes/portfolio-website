  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="z-10 text-center p-10">
        ...
        <TypingSubheader />
        <a href="https://carolinescodes.github.io/portfolio-website/Caroline_McMahon_Resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full shadow-lg hover:scale-105 hover:from-pink-500 hover:to-purple-500 transition-all duration-300 font-semibold animate-bounce mt-2">
          View My Resume
        </a>
      </div>
